...
- F5/Actualizar reconstruye Multiplayer Jobs directamente y, desde 0.37.0, conserva la selección de un servidor guardado por IP sin reutilizar una Entry vieja.
...
Estas auditorías se complementan: 0.37.0 no revierte 0.35.0 ni 0.36.0.
