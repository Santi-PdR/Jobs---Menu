...
> Informe histórico de la pasada del 2026-08-28. El estado vigente de 0.10.0,
> sus funciones perceptibles y sus pruebas pendientes están en
> [`EVOLUCION_4.md`](EVOLUCION_4.md), [`KNOWN_ISSUES.md`](../KNOWN_ISSUES.md) y
> [`checklist-manual.md`](checklist-manual.md). Este documento conserva el
> diagnóstico y las decisiones de esa auditoría, no una lista de tareas actual.
