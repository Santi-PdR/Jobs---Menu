...
> Documento de decisión. Audita el estado real (rama `arena/01a04c05-jobs-menu`, HEAD `2d93732`),
...
| Singleplayer (SelectWorldScreen) | **Sin cambio** | Llegada vía Ctrl+S (atajo oculto de servicio, nunca documentado). |
...
- **Final:** segunda auditoría, `clean build` con Java 17 (PC del owner), docs (README, CONTEXTO,
  ...
  **Backup C**, informe de 35 puntos. **No** se documenta Ctrl+S en ningún documento público.
