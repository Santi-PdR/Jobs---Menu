...
public final class HojaPapel {
    ...
    public static void dibujar(GuiGraphics grafico, int x0, int y0, int x1, int y1,
        ...
        // La version limpia conserva el documento y sus bordes, pero quita los
        // elementos decorativos que pueden distraer o competir con la tinta.
        if (!limpio) {
            grafico.fill(x0 + 3, y0 + 4, x1 + 3, y1 + 4,
